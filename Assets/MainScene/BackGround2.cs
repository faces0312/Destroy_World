...
public class BackGround2 : MonoBehaviour
{
    ...
    public void W()
    {
        ...
        {
            gameObject.transform.position = new Vector3(gameObject.transform.position.x, gameObject.transform.position.y - 5.85f);
        }
        else
        {
            gameObject.transform.position = new Vector3(gameObject.transform.position.x, gameObject.transform.position.y + 1.95f);
        }
    ...
    public void A()
    {
        ...
        {
            gameObject.transform.position = new Vector3(gameObject.transform.position.x + 5.85f, gameObject.transform.position.y);
        }
        else
        {
            gameObject.transform.position = new Vector3(gameObject.transform.position.x -1.95f, gameObject.transform.position.y);
        }
    }
